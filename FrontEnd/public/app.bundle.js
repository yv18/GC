...
/* harmony import */ var _Components_Images_VK_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Components/Images/VK.jpg */ "./SRC/Components/Images/VK.jpg");
...
function Chat() {
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    showContacts = _useState14[0],
    setShowContacts = _useState14[1];
    ...
    _socket_js__WEBPACK_IMPORTED_MODULE_1__["default"].on('typing', function (data) {
      if (data.sender !== stored) {
        if (data.text && data.text.trim() !== '') {
          setTypingIndicator("".concat(data.sender, " is typing: \"").concat(data.text, "\""));
        } else {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "".concat(theme === 'dark' ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-black' : 'bg-white', " w-full max-w-6xl h-[90vh] flex flex-col md:flex-row rounded-3xl shadow-2xl overflow-hidden")
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "fixed inset-0 z-50 md:static md:flex ".concat(showContacts ? 'flex' : 'hidden', " md:w-1/3 flex-col p-4 border-r border-gray-700 bg-gray-900 md:bg-transparent")
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
    className: "text-gray-100 text-2xl font-semibold mb-4 flex justify-between items-center"
  }, "Contacts", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    onClick: toggleContacts,
    className: "md:hidden text-2xl"
  }, "\u2716")), onlineUsers.map(function (user, idx) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: idx,
      ...
      src: _Components_Images_VK_jpg__WEBPACK_IMPORTED_MODULE_3__["default"],
    ...
    onClick: toggleTheme,
    className: "text-xl"
  }, theme === 'dark' ? '🌤️' : '🌙'))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
